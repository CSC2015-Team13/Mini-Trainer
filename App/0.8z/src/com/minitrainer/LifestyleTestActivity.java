...
public class LifestyleTestActivity extends Activity implements OnClickListener,OnTouchListener {
	...
	{
		int color = Color.BLACK; // whatever color you want
		String string = arg;
	...
	//	errors[2] = "Weight:";
		...
		weightFlag = boundCheck(20,300,weight);//.equals("OK");
		heightFlag = boundCheck(40,270,height);//.equals("OK");
		ageFlag = boundCheck(4,125,age);//.equals("OK");
	...
	private boolean stepTwoValid()
	{
		...
		hrsFlag = boundCheck(1,24,hrs);//.equals("OK");
		//setsFlag = boundCheck(0,50,sets);//.equals("OK");
		//minsFlag = boundCheck(0,60*24,mins);//.equals("OK");
		setsFlag = boundCheck(0,50,sets);//.equals("OK");
		minsFlag = boundCheck(0,40,mins);//.equals("OK");
	...
	private void provideFeedback(int a, int h, double w, int m, int s, int hrs, boolean ch)
	{
		...
		{
			good++;
			commentCheckbox = "You noted that you think you have a sedentary lifestyle. You should avoid sitting or lying for too long(usually that is the case when you watch TV, use the computer) particularly without any breaks or exercising inbetween. Such lifestyle can have a negative impact on your health. Therefore, we would advice you to become more active and keep track of how much you spend on activities that involve prolonged sitting or lying and do your daily exercise norm.";
		}
		else
		{
			commentCheckbox = "You did not note that you have a sedentary lifestyle. That is very good, keep it like that, stay active!";
		}
	...
	public boolean onTouch(View v, MotionEvent event) 
	{
		try{
			if (v.getId() == R.id.topLayer)
			{
				...
				//InputMethodManager imm = (InputMethodManager) LifestyleTestActivity.this.getSystemService(
	            //    android.content.Context.INPUT_METHOD_SERVICE);
				//imm.hideSoftInputFromWindow(LifestyleTestActivity.this.getCurrentFocus().getWindowToken(), 0);
			}
		}
		catch(Exception e)
		{
