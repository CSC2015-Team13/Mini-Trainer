...
public class ExerciseActivity extends Activity implements OnClickListener
{
    ...
    private void setupExercises()
    {
    	...
    	ex[0] = new Exercise(this,50,R.id.exButton1,R.id.exPanel1,R.id.arrLeft1,R.id.stepProgress1,R.id.arrRight1,R.id.currStep1,ex0Txt,R.id.complete_ex1,6000);//15
    	ex[1] = new Exercise(this,50,R.id.exButton2,R.id.exPanel2,R.id.arrLeft2,R.id.stepProgress2,R.id.arrRight2,R.id.currStep2,ex1Txt,R.id.complete_ex2,3000);//12
    	ex[2] = new Exercise(this,50,R.id.exButton3,R.id.exPanel3,R.id.arrLeft3,R.id.stepProgress3,R.id.arrRight3,R.id.currStep3,ex2Txt,R.id.complete_ex3,4500);//10
