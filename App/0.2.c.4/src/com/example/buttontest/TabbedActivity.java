...
public class TabbedActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   if (extras != null)
     //   {
     //   	int got_exp = Integer.parseInt(intent.getStringExtra("expPoints"));
	...
	public void onClick(View v) {
		...
		case R.id.increase_test:
			expBar.setProgress(expBar.getProgress()+5);
			experience.setText(String.valueOf(expBar.getProgress()));
			break;
