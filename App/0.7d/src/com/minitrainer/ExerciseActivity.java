...
public class ExerciseActivity extends Activity implements OnClickListener
{
    ...
    private void setupExercises()
    {
    	...
    	ex[1] = new Exercise(this,rewards[1],R.id.exButton1,R.id.exPanel1,R.id.arrLeft1,R.id.stepProgress1,R.id.arrRight1,R.id.currStep1,ex1Txt,R.id.exGuide1,ex1Img, R.id.complete_ex1,10000);//15
    	ex[2] = new Exercise(this,rewards[2],R.id.exButton2,R.id.exPanel2,R.id.arrLeft2,R.id.stepProgress2,R.id.arrRight2,R.id.currStep2,ex2Txt,R.id.exGuide2,ex2Img, R.id.complete_ex2,20000);//12
