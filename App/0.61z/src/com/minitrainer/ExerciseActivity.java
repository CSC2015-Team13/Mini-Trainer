...
public class ExerciseActivity extends Activity implements OnClickListener
{
    ...
    */
    private void setupExercises()
    {
    	...
    	ex[0] = new Exercise(this,rewards[0],R.id.exButton1,R.id.exPanel1,R.id.arrLeft1,R.id.stepProgress1,R.id.arrRight1,R.id.currStep1,ex0Txt,R.id.exGuide1,ex0Img, R.id.complete_ex1,50000);//15
    	ex[1] = new Exercise(this,rewards[1],R.id.exButton2,R.id.exPanel2,R.id.arrLeft2,R.id.stepProgress2,R.id.arrRight2,R.id.currStep2,ex1Txt,R.id.exGuide2,ex1Img, R.id.complete_ex2,30000);//12
    	ex[2] = new Exercise(this,rewards[2],R.id.exButton3,R.id.exPanel3,R.id.arrLeft3,R.id.stepProgress3,R.id.arrRight3,R.id.currStep3,ex2Txt,R.id.exGuide3,ex2Img, R.id.complete_ex3,145000);//10
    	ex[3] = new Exercise(this,rewards[3],R.id.exButton4,R.id.exPanel4,R.id.arrLeft4,R.id.stepProgress4,R.id.arrRight4,R.id.currStep4,ex3Txt,R.id.exGuide4,ex3Img, R.id.complete_ex4,45000);
    	ex[4] = new Exercise(this,rewards[4],R.id.exButton5,R.id.exPanel5,R.id.arrLeft5,R.id.stepProgress5,R.id.arrRight5,R.id.currStep5,ex4Txt,R.id.exGuide5,ex4Img, R.id.complete_ex5,45000);
    	ex[5] = new Exercise(this,rewards[5],R.id.exButton6,R.id.exPanel6,R.id.arrLeft6,R.id.stepProgress6,R.id.arrRight6,R.id.currStep6,ex5Txt,R.id.exGuide6,ex5Img, R.id.complete_ex6,45000);
    	ex[6] = new Exercise(this,rewards[6],R.id.exButton7,R.id.exPanel7,R.id.arrLeft7,R.id.stepProgress7,R.id.arrRight7,R.id.currStep7,ex6Txt,R.id.exGuide7,ex6Img, R.id.complete_ex7,45000);
    	ex[7] = new Exercise(this,rewards[7],R.id.exButton8,R.id.exPanel8,R.id.arrLeft8,R.id.stepProgress8,R.id.arrRight8,R.id.currStep8,ex7Txt,R.id.exGuide8,ex7Img, R.id.complete_ex8,45000);
