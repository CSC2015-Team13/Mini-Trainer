 ...
 * 
 * Description: Activity that allows user to change a few settings which will be stored on the device(locally)
 */
public class SettingsActivity extends Activity implements OnClickListener{
	...
	// sets up data that will be returned and goes back to TabbedActivity
	@Override
	public void onBackPressed() 
	{
		if (!resetRequest)
		{
			...
			setResult(RESCODE_OTHERSETS, intent);
		}
	    super.onBackPressed();
	}
	
	// sets up alert to change user's username(cosmetic setting)
	...
	//sets up alert(s) to reset all progress
	...
	//class that resets progress on the server
