...
public class ExerciseActivity extends Activity implements OnClickListener
{
    ...
    private void setupExercises()
    {
    	...
    	ex[0] = new Exercise(this,15,R.id.exButton1,R.id.exPanel1,R.id.complete_ex1,60000);
    	ex[1] = new Exercise(this,12,R.id.exButton2,R.id.exPanel2,R.id.complete_ex2,30000);
    	ex[2] = new Exercise(this,10,R.id.exButton3,R.id.exPanel3,R.id.complete_ex3,45000);
