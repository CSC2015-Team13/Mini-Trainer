 ...
 *  
 *  Description: Activity that acts as a lifestyle test for the user that gives feedback based on user's inputs
 */
public class LifestyleTestActivity extends Activity implements OnClickListener,OnTouchListener {
	...
	private void provideFeedback(int a, int h, double w, int m, int s, int hrs, boolean ch)
	{
		...
		String commentSleep = "";
		String commentSleepFew = " hours of sleep a day is not enough, you need more sleep to avoid sleep deprivation which might have negative impact on your health!";
