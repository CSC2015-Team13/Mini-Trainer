...
public class QuestionnaireActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sv.setBackgroundColor(Color.parseColor("#e7e7e9"));
	...
	private void provideFeedback(int a, int h, double w, int m, int s, int hrs, boolean ch)
	{
		...
		String commentSets = ".\nYou should try to break your activities into smaller segments of 10-15 minutes instead of doing everything in one or a couple of goes.\n";
		...
		if (adult)
		{
			...
			{
				commentMins += " (30 minutes per day is the norm for adults).\n";
			}
			if(s >= 2 && s <= 3 && m >= 30)
			{
				...
				if (m / (s * 1.0) > 15)
				{
					commentSets = ".\nYou should try to break your activities into smaller segments of 10-15 minutes instead of doing everything in one or a couple of goes. However, if you go to gym it's OK to workout for more than 15 minutes";
					//commentSets = " and you are doing your exercises efficiently (10-15 minutes a single set of exercises activites unless you go to the gym)\n";
				}
				else commentSets = " and you are doing your exercises efficiently (10-15 minutes on a single set of exercise activites)\n";
			}
			else
			{
				if (s == 0 || s > 3 && m < 30)
				...
				else
				{
					if (s > 3 && s * 10 <= m)
					{
						...
						good++;
						commentSets = ".\nYou should try to break your activities into smaller segments of 10-15 minutes instead of doing everything in one or a couple of goes. However, if you go to gym it's OK to workout for more than 15 minutes";
						//commentSets = "and you are doing your excercises efficiently (10-15 minutes or more on a single set of exercises activites)\n";
					}
				}
			}
			if (hrs  == 7 || hrs == 8)
